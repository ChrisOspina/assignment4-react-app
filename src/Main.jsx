    ...
    <blog>
      <posts>
       <post id="1">
           ...
           <summary>
               <image_path>https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/ChatGPT_logo.svg/1200px-ChatGPT_logo.svg.png</image_path>
       ...
       <post id="2">
           ...
           action movie. I am anticipating a sequel or even a shared Nintendo universe leading to a Super Smash Bros Movie that incorporates Zelda
           and Pokemon. This is also part of a renaissance of animation from Universal Pictures that began with The Bad Guys and which included
       ...
       <post id="3">
           ...
           <summary>
               <image_path>https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbbitGAYVFzzZvhLmiSUEioiE8cZ8rCaZu_n6B2oiZXA</image_path>
    ...
    return (
      <main>
        {selectedPost ? (
          ...
          posts.map((post) => (
            <article align="center" key={post.attributes.id}>
              <h2>
              ...
              <p>
                <span className='date'>{post.children.find((el) => el.name === 'date').content}</span>
                <br/>
                <span className='author'>{post.children.find((el) => el.name === 'author').content}</span>
              </p>
              <div className='summary'>
                <span className='text'>{post.children.find((el) => el.name === 'summary').content}</span>
              </div>
              <span className='body'>{post.children.find((el) => el.name === 'body').content}</span>
            </article>
          ))
        )}
      </main>
